...
export default class CategoriesInvoker implements ReactiveController {
  ...
  async load_categories() {
    await invoke("get_categories").then((result) => {
      ...
      this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "load_categories: success", cmd: "get_categories", args: {} }}));
    }).catch((err) => {
       this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "load_categories: " + err, cmd: "get_categories", args: {} }}));
    });
  }
  ...
  async reload_categories() {
    await invoke("get_categories").then((result) => {
      ...
      this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "reload_categories: success", cmd: "get_categories", args: {} }}));

    }).catch((err) => {
       this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "reload_categories: " + err, cmd: "get_categories", args: {} }}));
    });
  }
  ...
  onUpdateCategoryTitle = async (ev: CustomEvent) => {
    ...
    await invoke("update_tag_title", args).then((_) => {
      this.host.main_controller.load_data();
        ...
        this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "onUpdateCategoryTitle: success", cmd: "update_tag_title", args: args }}));
      
    }).catch((err) => {   
      this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "onUpdateCategoryTitle: " + err, cmd: "update_tag_title", args: args }}));
    });
  }
  ...
  onDeleteCategory = async(ev: CustomEvent) => {
     await invoke("get_snippet_count_for_tag", { tagId: ev.detail.tag_id }).then(async (count_result) => {
        ...
        this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "onDeleteCategory: success", cmd: "get_snippet_count_for_tag", args: { tagId: ev.detail.tag_id } }}));
        ...
        if(answer) {
          await invoke("delete_category", { tagId: ev.detail.tag_id }).then((_) => {
            ...
            this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "onDeleteCategory: success", cmd: "delete_category", args: { tagId: ev.detail.tag_id } }}));
            this.reload_categories();
          }).catch((err) => {
            this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "onDeleteCategory: " + err, cmd: "delete_category", args: { tagId: ev.detail.tag_id } }}));
          });
        }
     }).catch((err) => {
      this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "onDeleteCategory: " + err, cmd: "get_snippet_count_for_tag", args: { tagId: ev.detail.tag_id } }}));
     });
  ...
  onAddCategory = async(ev: CustomEvent) => {
    ...
    const args = { parentId: parent_id, title: ev.detail.title };
      await invoke("create_category", args).then((_) => {
        ...
        this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "onAddCategory: success", cmd: "create_category", args: args }}));
        this.reload_categories();
      }).catch((err) => {
        this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "onAddCategory: " + err, cmd: "create_category", args: args }}));
  ...
  onUpdateParentCategory = async (ev: CustomEvent) => {
    ...
    await invoke("set_tag_parent_id", args).then((_) => {
      ...
      this.host.dispatchEvent(new CustomEvent('invoke-debug', {detail: {info: "onUpdateParentCategory: success", cmd: "set_tag_parent_id", args: args }}));
    }).catch((err) => {
      this.host.dispatchEvent(new CustomEvent('invoke-error', {detail: {info: "onUpdateParentCategory: " + err, cmd: "set_tag_parent_id", args: args }}));
    });
  }
